...
public class Main {
     ...
     */
    public static TransitModel readModel(String filename) {  // TODO HELP INFO IMPORTANT SUPER DUPER IMPORTANT TODO!!!!!!!
    ...
    private static void createEdge(int line, Node node1, Node node2, double length) {
