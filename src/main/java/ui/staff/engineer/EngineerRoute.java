...
/**
 * EngineerRoute is a JPanel that displays the route that the engineer is assigned to.
...
public class EngineerRoute extends JPanel {
     ...
     */
    public EngineerRoute(UIController controller, EmployeeDTO employeeDTO) {
        ...
        operatorLabel.setFont(new Font("Arial", Font.PLAIN, 25));

        // engineer label
        String engineer = "zoey"; // TODO: should be .getEngineer()
        JLabel engineerLabel = new JLabel("Engineer: " + engineer);
        engineerLabel.setFont(new Font("Arial", Font.ITALIC, 25));
