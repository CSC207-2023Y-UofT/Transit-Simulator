package train.old;
/*
 *  Note: Map is already an interface defined by Java so I renamed to train.old.Plot.
 *  This will be where the main updating system will be. The train.old.Plot contains all Tracks and Trains, and will update them
 ...
 * specific scenario (time, places, etc)  which would be tiring. train.old.Main thing is this is where updates happen.
 */
